                            ...
                            <div class="form_group ">
                                ...
                                <div class="form_group__box--add_product">
                                    <div class="form_group__add_product--item_input">
                                        ...
                                        <input type="text" class="form_group__item_input--input" name="nameProduct" id="add_product--input" placeholder="Nhập tên sản phẩm">
                                    </div>
                                    <div class="form_group__add_product--item_input">
                                        <label for="add_product--input" class="form_group__item_input--text">Giá sản phẩm</label> <br>
                                        <input type="text" class="form_group__item_input--input" name="priceProduct" id="add_product--input" placeholder="Nhập giá sản phẩm">
                                    </div>
                                       ...
                                       <select name="selectCatalog" id="add_product--select" class="form_group__item_select--option">
                                        ...
                                        <?php
                                            foreach($listCatalog as $cata){
                                                extract($cata);
                                                echo '<option value="'.$id.'">'.$name_catalog.'</option>';
                                            }
                                        ?>
                                    ...
                                    <div class="form_group__add_product--item_select">
                                       ...
                                       <select name="selectType" id="add_product--select" class="form_group__item_select--option">
                                        <option value="1">chưa chọn sản phẩm</option>
                                    ...
                                    <div class="form_group__add_product--item_input">
                                        ...
                                        <input type="text" class="form_group__item_input--input" name="qtyProduct" id="add_product--input" placeholder="Nhập số lượng sản phẩm">
                                    </div>
