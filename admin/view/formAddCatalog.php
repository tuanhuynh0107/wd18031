                            ...
                            <div class="form_group ">
                                ...
                                <div class="form_group__box--add_product">
                                    <div class="form_group__add_product--item_input">
                                        ...
                                        <input type="text" class="form_group__item_input--input" name="nameCatalog" id="add_product--input" placeholder="Nhập tên sản phẩm">
                                    </div>  
                                    <div class="form_group__add_product--item_input">
                                    ...
                                    <div class="form_group__add_product--item_input">
                                        ...
                                        <input type="file" class="form_group__item_input--icon"   name="icon_catalog" id="add_product--input"  placeholder=" ví dụ #CUA00235">
                                    </div>
                                    <div class="form_group__add_product--item_submit">
                                        ...
                                        <input type="submit" class="form_group__submit--them input-submit__loaihang" name="addCata" value="Thêm">
                                        <?php
                                        if(isset($thongbao)){
                                            echo  $thongbao;
                                        }
