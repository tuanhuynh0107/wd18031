                                ...
                                <div class="form_group__box-input">
                                    <div class="form_group__input-file--product">
                                        <label for="input-file">
                                            <img src="../assets/img/banner_product/<?=$banner_catalog?>.png" alt="" width="500">
                                        ...
                                        <input type="file" class="form_group__input-file" name="img_catalog" id="input-file" value="">
                                    </div> 
                                </div>
                                
                                <div class="form_group__box--add_product">
                                    <div class="form_group__add_product--item_input">
                                        <label for="add_product--input" class="form_group__item_input--text">Tên loại hàng</label> <br>
                                    ...
                                    <div class="form_group__add_product--item_input">
                                        ...
                                        <input type="text" class="form_group__item_input--input" name="quantityCatalog" id="add_product--input"  value="<?=$qty_catalog?>">
                                    </div>
                                    <div class="form_group__add_product--item_input">
                                        <label for="add_product--input" class="form_group__item_input--text">Trạng thái</label> <br>
                                        <input type="text" class="form_group__item_input--input"  name="satus" id="add_product--input"  value="<?=$status_catalog?>">
                                    </div>
                                    <div class="form_group__add_product--item_input">
                                        <label for="add_product--input" class="form_group__item_input--text">Icon đại diện</label> <br>
                                        <img src="../assets/icons/<?=$img_catalog?>.png" alt="" >
                                        <input type="file" class="form_group__item_input--icon"   name="icon_catalog" id="add_product--input" value="<?=$name_catalog?>" >
                                    </div>
