...
<body>
    <?php
        // echo 'Đây là id của sản phẩm :'.$id_user; 
        foreach($loadComment as $ItemC){
            extract($ItemC);
            if(isset($_SESSION['user_info']['username'])&&isset($_SESSION['user_info'])){
                $showNameUser=$_SESSION['user_info']['username'];
            }else{
                $showNameUser="Người dùng";
            }
            echo '<div class="history__comment--box row" >
            <!-- load tên khách hàng -->
    ...
    <form action="<?=$_SERVER['PHP_SELF'];?>" method="post">
        ...
        <input type="submit" value="Gửi" name="sendComment"  id="comment__send">
        <!-- <label for="comment__send" class="comment__send--icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                <path d="M27.1875 2.8125L2.8125 14.0625L14.0625 16.4062M27.1875 2.8125L17.8125 27.1875L14.0625 16.4062M27.1875 2.8125L14.0625 16.4062" stroke="black" stroke-width="1.875" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
