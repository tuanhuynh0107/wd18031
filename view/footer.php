        ...
        <div class="main-content">
            <div class="row">
                ...
                <div class="column">
                    ...
                    <p class="desc">
                        Cần tìm hải sản tươi sống, cam kết 100% chất lượng khi đến tay người dùng, liên hệ ngay cho
                        Hải sản Miền tây.
                    </p>
                    <div class="socials">
                        <a href="#!">
                ...
                <!-- Column 2 -->
                <div class="column">
                    <h3 class="title">Về doanh nghiệp</h3>
                    <ul class="list">
                        <li>
                            <a href="#!">Về doanh nghiệp</a>
                        </li>
                        <li>
                            <a href="#!">Đặc trừng</a>
                        </li>
                ...
                <div class="column">
                    ...
                    <ul class="list">
                        <li>
                            <a href="#!">
                                <strong>Địa chỉ:</strong> 27 Division St,
                                New York, NY 10002, VIETNAM
                            </a>
                        </li>
                        <li>
                            <a href="#!">
                                <strong>Email:</strong> haisanmientay.support@gmail.com
                            </a>
                        </li>
                        <li>
                            <a href="#!">
                                <strong>Số điện thoại:</strong> +84 907 578 881
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="copyright">
                <p>Copyright ©2023 Ps27414_Huỳnh Võ Hoàng Tuấn</p>
            </div>
        </div>
    </footer></footer>
</body>
