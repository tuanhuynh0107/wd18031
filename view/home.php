            ...
            <div class="main-hero">
                <nav class="navbar">
                    <ul class="navber__menu">
                        ...
                        <li class="menu__catalog">
                            <a href="" class="menu__catalog--act row">
                                <img src="./assets/icons/dacsan.png" alt="" class="catalog__act--icon">
                                <span class="catalog__act--title">Đặc sản miền tây</span>
                            </a>
                        </li>
                        <li class="menu__catalog">
                            <a href="" class="menu__catalog--act row">
                                <img src="./assets/icons/kho.png" alt="" class="catalog__act--icon">
                                <span class="catalog__act--title">Khô Miền Tây</span>
                            </a>
                        </li>
                        <li class="menu__catalog">
                            <a href="" class="menu__catalog--act row">
                                <img src="./assets/icons/fiht.png" alt="" class="catalog__act--icon">
                                <span class="catalog__act--title">Cá</span>
                            </a>
                        </li>
                        <li class="menu__catalog">
                            <a href="" class="menu__catalog--act row">
                                <img src="./assets/icons/clam.png" alt="" class="catalog__act--icon">
                                <span class="catalog__act--title">Ngao, Sò, ỐC</span>
                            </a>
                        </li>
                        <li class="menu__catalog">
                            <a href="" class="menu__catalog--act row">
                                <img src="./assets/icons/grap.png" alt="" class="catalog__act--icon">
                                <span class="catalog__act--title">Cua, Ghẹ</span>
                            </a>
                        </li>
                        <li class="menu__catalog">
                            <a href="" class="menu__catalog--act row">
                                <img src="./assets/icons/swit.png" alt="" class="catalog__act--icon">
                                <span class="catalog__act--title">Mực</span>
                            </a>
                        </li>
                        <li class="menu__catalog">
                            <a href="" class="menu__catalog--act row">
                                <img src="./assets/icons/logter.png" alt="" class="catalog__act--icon">
                                <span class="catalog__act--title">Tôm các loại</span>
                            </a>
                        </li>
                        <li class="menu__catalog">
                            <a href="" class="menu__catalog--act row">
