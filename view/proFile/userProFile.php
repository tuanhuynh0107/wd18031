            ...
            <div class="proFile__sidebar">
                <div class="sidebar--top row">
                    ...
                    <div class="sidebar--top__right row">
                        <div class="sidebar--top__right--content "><?=$loadUser['username']?></div>
                        <div class="sidebar--top__right--content"><?=$loadUser['dob']?></div>
                        <div class="sidebar--top__right--content ">
                            <?php
                                if($loadUser['gender']==1){
                                    echo 'Nam';
                                }else{
                                    if($loadUser['gender']==2){
                                        echo 'Nữ';
                                    }else{
                                        echo 'Khác';
                                    }
                        ...
                        <div class="sidebar--top__right--content line-clamp line-1"><?=$loadUser['address']?></div>
                    </div>
                </div>
                        ...
                        <form action="index.php?page=changeProfile" method="post" class="form-change">
                            <div class="change__proFile">
                                <div class="form__group">
                                    ...
                                    <input type="text" id="fistName" name="name_user" value="<?=$loadUser['username']?>" class="change__fullName">
                                </div>
                                <div class="form__group">
                                    ...
                                    <input type="text" id="lastName" name="email_user" value="<?=$loadUser['email']?>" class="change__fullName">
                                </div>
                                <div class="form__group">
                                ...
                                <div class="form__group">
                                    ...
                                    <input type="date" id="fullName" name="dob_user" value="<?=$loadUser['dob']?>" class="change__fullName">
                                </div>
                                <div class="form__group">
                                ...
                                <div class="form__group">
                                    ...
                                    <input type="text" id="fullName" name="adress_user" value="<?=$loadUser['address']?>" class="change__fullName">
                                </div>
                            </div>
