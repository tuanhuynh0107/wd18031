                    ...
                    <div class="change__main">
                        <form action="" method="post">
                            <div class="form__group change__group">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTz-gB4APG_8aESq4eUzCWTMYa_moWsW_QHYw&usqp=CAU" alt="user" class="change__img--user">
                            ...
                            <form action="" method="post" class="form-change">
                                <div class="change__proFile">
                                    <div class="form__group">
                                        ...
                                        <input type="text" id="fistName" value="Huỳnh Ngọc" class="change__fullName">
                                    </div>
                                    <div class="form__group">
                                        ...
                                        <input type="text" id="lastName" value="Huỳnh Ngọc" class="change__fullName">
                                    </div>
                                    <div class="form__group">
                                    ...
                                    <div class="form__group">
                                        ...
                                        <input type="date" id="fullName" value="Huỳnh Ngọc" class="change__fullName">
                                    </div>
                                    <div class="form__group">
                                        ...
                                        <input type="text" id="fullName" value="Huỳnh Ngọc" class="change__fullName">
                                    </div>
                                    <div class="form__group">
                                ...
                                <input type="submit" value="Thay đổi" class="change__btn--full">
                            </form>
